        ...
        private void  BtnYClick(object sender, EventArgs e)
        {
            ...
            if (decimal.TryParse(amountText, out amount) && amount > 0 && amount % 5 == 0)
            {
                ...
                try
                {
                    ...
                    NetworkClient.SendRequest("{\"request_type\": \"" + TransactionData.transactionType + "\", \"atm_id\":\"" + TransactionData.ATMID + "\", \"pan_number\":\"" + TransactionData.currentPAN + "\",\"pin\":\"" + TransactionData.PIN + "\",\"card_type\":\"" + TransactionData.currentCardType + "\", \"transaction_value\": \"" + amount + "\"}");
